...
from wild_blueberry.entity.config_entity import DataTransformationConfig
...
class DataTransformation:
    ...
    def get_data_transformation(self):
        try:
            ...
            selected_features = ["clonesize", "honeybee", "bumbles", "andrena", "osmia", "MaxOfUpperTRange", "RainingDays", "fruitset", "yield"]
